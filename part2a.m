function [X,eigval] = part2a(fs,N,f,A,meth,lhh)
...
if (meth == "FE")
    ...
    for ii = 1:N-1 % Calculate for each sample
        ...
        Le0 = Le(0,ordLe,Le4,Le8);
        Lexn = Le(xn,ordLe,Le4,Le8);
        dLexn = dLe(xn,ordLe,Le4,Le8);
        Blxn = Bl(xn,ordBl,Bl4,Bl8);
        Cmxn = Cm(xn,ordCms,Cms4,Cms8);
...
function Leout = Le(xn,ordLe,Le4,Le8)
    if ordLe <=4
        Lec = Le4(1:ordLe+1);
    else
        Lec = Le8(1:ordLe+1);
...
function dLeout = dLe(xn,ordLe,Le4,Le8)
    if ordLe <=4
        Lec = Le4(2:1+ordLe);
    else
        Lec = Le8(2:1+ordLe);
...
function Blout = Bl(xn,ordBl,Bl4,Bl8)
    if ordBl <=4
        Blc = Bl4(1:ordBl+1);
    else
        Blc = Bl8(1:ordBl+1);
...
function Cmout = Cm(xn,ordCms,Cms4,Cms8)
    if ordCms <=4
        Cmsc = Cms4(1:ordCms+1);
    else
